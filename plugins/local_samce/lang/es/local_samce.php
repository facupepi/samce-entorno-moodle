...
$string['retentionnotice'] = 'Plazo de conservación (para el aviso)';
$string['retentionnotice_desc'] = 'Cuánto tiempo se conservan los datos, redactado para el alumno (por ejemplo: "90 días desde la finalización del examen"). Se le muestra en el aviso previo al examen. Este ajuste solo informa: la supresión efectiva la hace el backend (variable RETENTION_DAYS).';
