...
$string['retentionnotice'] = 'Data retention period (in days)';
$string['retentionnotice_desc'] = 'Number of days the data is kept, counted from the end of the exam (for example: 90). It is shown to the student in the notice before the exam. This setting only informs: for the data to actually be deleted, the same period must be configured on the SAMCE server.';
...
$string['gatenoticerequired'] = 'Before taking this exam you must read the monitoring notice. Tap "Attempt quiz now" to see it and continue.';
$string['gatebrowserrequired'] = 'This exam can only be taken with Google Chrome on a computer. Open it with Google Chrome on a computer to take it.';
$string['consentaccepterror'] = 'Reading the notice could not be recorded. Check your connection and try again.';
$string['privacy:preference:start'] = 'The time you accepted the monitoring notice to start an exam attempt.';
$string['retentiondays'] = '{$a} days after the exam is finished';
$string['retentionday'] = '1 day after the exam is finished';
$string['nojsblocked'] = 'This exam requires JavaScript to be enabled. Enable it in your browser and reload the page.';
$string['tasksendcapturestatus'] = 'Tell SAMCE that an exam page was loaded without capture';
$string['tasksendcapturestatusfailed'] = 'Could not tell SAMCE that an exam page was loaded without capture';
$string['privacy:preference:page'] = 'The time the last page of an exam attempt was delivered (to know whether capture started).';
$string['privacy:preference:seen'] = 'The time event capture started on the last page of an exam attempt.';
$string['privacy:preference:alert'] = 'The time SAMCE was told that a page of an exam attempt was loaded without capture.';
